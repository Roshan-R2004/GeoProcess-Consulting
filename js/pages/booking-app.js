...
function BookingApp(){
  return <div className="booking-shell">
    <aside className="booking-info">
      ...
      <h2 className="booking-title">Book a project discussion.</h2>
      <p>
...
function SetupMessage(){
  return <div className="booking-setup">
    ...
    <p>
      ...
      official embed code into <code>js/booking-config.js</code>.
    </p>
    <div className="setup-steps">
      ...
      <div><b>5</b><span>Copy Google's embed code and paste it into <code>js/booking-config.js</code>.</span></div>
    </div>
